...
_ANTHROPIC_VERIFIED_AT = "2026-07-26"
_OPENAI_MODEL_SOURCE = "https://platform.openai.com/docs/models"
_GOOGLE_MODEL_SOURCE = "https://ai.google.dev/gemini-api/docs/latest-model"
_QWEN_MODEL_SOURCE = "https://help.aliyun.com/zh/model-studio/text-generation-model/"
_ZHIPU_MODEL_SOURCE = "https://docs.bigmodel.cn/cn/guide/start/model-overview"
_MINIMAX_MODEL_SOURCE = "https://platform.minimaxi.com/docs/api-reference/text-chat"
...
BUILTIN_MODELS: dict[str, ModelCatalogEntry] = {
    ...
    "k3": ModelCatalogEntry(
        ...
        description="Kimi Coding Plan K3；上游 Model ID 为 k3",
        context_window_tokens=1_048_576,
        max_output_tokens=131_072,
        context_window_source="unverified_provider_docs",
    ),
    "k3-256k": ModelCatalogEntry(
        alias="k3-256k",
        name="Kimi K3 256K",
        provider_type="openai",
        default_model_id="k3-256k",
        capabilities=["coding", "reasoning", "tool_use"],
        input_price_per_1m=3.0,
        output_price_per_1m=15.0,
        description="Kimi Coding Plan 256K；上游 Model ID 为 k3-256k",
        context_window_tokens=262_144,
        max_output_tokens=131_072,
        context_window_source="unverified_provider_docs",
    ),
    "kimi-for-coding-highspeed": ModelCatalogEntry(
        alias="kimi-for-coding-highspeed",
        name="Kimi Coding Highspeed",
        provider_type="openai",
        default_model_id="kimi-for-coding-highspeed",
        capabilities=["coding", "tool_use"],
        input_price_per_1m=1.0,
        output_price_per_1m=1.0,
        description="Kimi Coding Plan 高速模型；上游 Model ID 为 kimi-for-coding-highspeed",
    ),
    ...
    "claude-opus-4-8": ModelCatalogEntry(
        ...
        provider_type="anthropic",
        # Compatibility alias; new configurations use claude-opus-5.
    ...
    "claude-opus-5": ModelCatalogEntry(
        alias="claude-opus-5",
        name="Claude Opus 5",
        provider_type="anthropic",
        default_model_id="claude-opus-5",
        ...
        input_price_per_1m=5.0,
        output_price_per_1m=25.0,
        description="Anthropic Claude Opus 5，复杂 Agent 与企业工程",
        context_window_tokens=1_000_000,
        max_output_tokens=128_000,
        context_window_source=_ANTHROPIC_MODEL_SOURCE,
        context_window_verified_at=_ANTHROPIC_VERIFIED_AT,
    ...
    "gpt-5.6-sol": ModelCatalogEntry(
        ...
        description="OpenAI GPT-5.6 Sol，复杂推理与编程",
        context_window_tokens=1_050_000,
        max_output_tokens=128_000,
        context_window_source=_OPENAI_MODEL_SOURCE,
        context_window_verified_at="2026-07-26",
        metadata_source=_OPENAI_MODEL_SOURCE,
        metadata_verified_at="2026-07-26",
    ),
    "gpt-5.6-terra": ModelCatalogEntry(
        ...
        output_price_per_1m=15.0,
        description="OpenAI GPT-5.6 Terra，能力与成本平衡",
        context_window_tokens=1_050_000,
        max_output_tokens=128_000,
        context_window_source=_OPENAI_MODEL_SOURCE,
        context_window_verified_at="2026-07-26",
    ...
    "gpt-5.6-luna": ModelCatalogEntry(
        ...
        description="OpenAI GPT-5.6 Luna，成本敏感与高吞吐",
        context_window_tokens=1_050_000,
        max_output_tokens=128_000,
        context_window_source=_OPENAI_MODEL_SOURCE,
        context_window_verified_at="2026-07-26",
    ...
    "kimi-k3": ModelCatalogEntry(
        ...
        name="Kimi K3",
        provider_type="openai",
        # Keep the descriptive alias for existing configs, but send the
        # exact Kimi Coding API identifier upstream.
        default_model_id="k3",
        capabilities=["coding", "reasoning", "tool_use", "vision"],
        input_price_per_1m=3.0,
        output_price_per_1m=15.0,
        description="Moonshot Kimi K3；上游 Model ID 为 k3，1M 上下文元数据未逐项核实",
        context_window_tokens=1_048_576,
        max_output_tokens=131_072,
    ...
    "kimi-k2.7-code": ModelCatalogEntry(
        ...
        input_price_per_1m=1.0,
        output_price_per_1m=1.0,
        description="Kimi K2.7 Code；上游 Model ID 为 k3-256k",
    ),
    ...
    "glm-5.2": ModelCatalogEntry(
        ...
        capabilities=["coding", "reasoning", "tool_use", "vision"],
        description="智谱 GLM-5.2，最新旗舰模型",
        context_window_tokens=1_000_000,
        max_output_tokens=128_000,
        context_window_source=_ZHIPU_MODEL_SOURCE,
        context_window_verified_at="2026-07-26",
        metadata_source=_ZHIPU_MODEL_SOURCE,
        metadata_verified_at="2026-07-26",
    ),
    ...
    "minimax-m3": ModelCatalogEntry(
        ...
        description="MiniMax M3，Coding/Agentic 模型",
        context_window_tokens=1_000_000,
        max_output_tokens=64_000,
        context_window_source=_MINIMAX_MODEL_SOURCE,
        context_window_verified_at="2026-07-26",
        metadata_source=_MINIMAX_MODEL_SOURCE,
        metadata_verified_at="2026-07-26",
    ),
    ...
    "qwen3.8-max-preview": ModelCatalogEntry(
        alias="qwen3.8-max-preview",
        name="Qwen3.8 Max Preview",
        provider_type="openai",
        default_model_id="qwen3.8-max-preview",
        capabilities=["coding", "reasoning", "tool_use"],
        description="阿里云百炼 Qwen3.8 Max Preview",
        context_window_tokens=1_000_000,
        max_output_tokens=64_000,
        context_window_source=_QWEN_MODEL_SOURCE,
        context_window_verified_at="2026-07-26",
        metadata_source=_QWEN_MODEL_SOURCE,
        metadata_verified_at="2026-07-26",
    ),
    ...
    "qwen3.7-plus": ModelCatalogEntry(
        ...
        capabilities=["coding", "reasoning", "tool_use", "vision"],
        description="阿里云百炼 Qwen3.7 Plus，适合 Coding/Agent",
        context_window_tokens=1_000_000,
        max_output_tokens=64_000,
        context_window_source=_QWEN_MODEL_SOURCE,
        context_window_verified_at="2026-07-26",
    ...
    "qwen3.7-flash": ModelCatalogEntry(
        ...
        name="Qwen3.7 Flash",
        provider_type="openai",
        default_model_id="qwen3.7-flash",
        capabilities=["coding", "reasoning", "tool_use", "vision"],
        description="阿里云百炼 Qwen3.7 Flash，低成本高吞吐",
        context_window_tokens=1_000_000,
        max_output_tokens=64_000,
        context_window_source=_QWEN_MODEL_SOURCE,
        context_window_verified_at="2026-07-26",
    ...
    "gemini-3.6-flash": ModelCatalogEntry(
        ...
        description="Google Gemini 3.6 Flash，Agent 与多模态",
        context_window_tokens=1_000_000,
        max_output_tokens=64_000,
        context_window_source=_GOOGLE_MODEL_SOURCE,
        context_window_verified_at="2026-07-26",
        metadata_source=_GOOGLE_MODEL_SOURCE,
        metadata_verified_at="2026-07-26",
    ),
    "gemini-3.5-flash-lite": ModelCatalogEntry(
        ...
        description="Google Gemini 3.5 Flash-Lite，高吞吐低成本",
        context_window_tokens=1_000_000,
        max_output_tokens=64_000,
        context_window_source=_GOOGLE_MODEL_SOURCE,
        context_window_verified_at="2026-07-26",
...
PROVIDER_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "zhipu_glm": {
        ...
        "timeout": 120,
        "rpm_limit": 60,
        "supported_models": ["glm-5.2", "glm-5"],
    },
    "qwen": {
