...
![Status](https://img.shields.io/badge/status-v0.1.0--beta.2-f59e0b)
...
当前公开版本为 [`v0.1.0-beta.2`](https://github.com/Wanbinyu/multi-agent-orchestrator/releases/tag/v0.1.0-beta.2)。它适合在可信本机和可审查项目中试用，不是 Claude Code、Codex 或容器沙箱的完整替代品。
...
项目已通过公开发布验收并发布 `v0.1.0-beta.2`。`beta.3` 的 B3.1 Provider 能力真值已经完成，当前下一步是 B3.2 官方 Anthropic 预设与连接；详细执行顺序见 [`docs/版本计划-v0.1.0-beta.3至beta.6.md`](docs/版本计划-v0.1.0-beta.3至beta.6.md)，跨设备恢复入口见 [`docs/项目进度与关键操作.md`](docs/项目进度与关键操作.md)。
