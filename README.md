...
项目已通过公开发布验收并发布 `v0.1.0-beta.2`；后续稳定性、透明度和模型路由计划见 [`docs/MAO-产品方向与Beta路线图.md`](docs/MAO-产品方向与Beta路线图.md)。
...
见 [`docs/MAO-产品方向与Beta路线图.md`](docs/MAO-产品方向与Beta路线图.md)。当前优先级是 Beta 用户验证与稳定性、CLI/Web 工程透明度、长任务上下文和可复现的 token/完成率基准。
