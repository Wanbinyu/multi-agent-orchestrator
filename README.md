...
项目已通过公开发布验收并发布 `v0.1.0-beta.2`。当前下一步是 `beta.3` 的 B3.1 Provider 能力真值；详细执行顺序见 [`docs/版本计划-v0.1.0-beta.3至beta.6.md`](docs/版本计划-v0.1.0-beta.3至beta.6.md)，跨设备恢复入口见 [`docs/项目进度与关键操作.md`](docs/项目进度与关键操作.md)。
